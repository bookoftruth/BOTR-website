...
const Navbar = ({ isMuted, setIsMuted }) => {
  ...
  return (
    <div className="fixed top-0 h-24 w-full z-20 flex items-center px-4">
      <a
        href="/"
        className="text-start font-gothic text-black text-shadow-white text-3xl xl:text-5xl flex-shrink-0"
      >
        Book of Truth
      </a>
      ...
      <div className="ml-auto flex flex-row gap-6 xs:gap-10 items-center">
        ...
        <div className="hidden lg:flex flex-row justify-center items-center text-3xl text-white text-shadow-black gap-6 xs:gap-10">
          <a href="/">Book of Truth</a>
